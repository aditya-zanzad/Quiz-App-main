...
import { generateQuizQuestions, generateAdaptiveQuestions, generateQuestionsFromText } from "../controllers/aiQuestionController.js";
...
router.post("/generate-from-text", verifyToken, generateQuestionsFromText);
